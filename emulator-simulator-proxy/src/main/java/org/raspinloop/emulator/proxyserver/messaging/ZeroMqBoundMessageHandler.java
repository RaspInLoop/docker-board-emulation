 ...
 * This component is only Binding to another side, e.g. ZeroMq proxy.
 * <p>
 ...
 * @since 5.4
 */
public class ZeroMqBoundMessageHandler extends AbstractReactiveMessageHandler {
	 ...
	 */
	public ZeroMqBoundMessageHandler(ZContext context, String connectUrl) {
	 ...
	 *    only {@link SocketType#PAIR}, {@link SocketType#PUB} and {@link SocketType#PUSH} are supported.
	 */
	public ZeroMqBoundMessageHandler(ZContext context, String connectUrl, SocketType socketType) {
		...
		this.socketMono =
				Mono.just(context.createSocket(socketType))
						...
						.doOnNext((socket) -> socket.bind(connectUrl))
						.cache()
						.publishOn(this.publisherScheduler);
	}
