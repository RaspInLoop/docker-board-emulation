...
public class I2CDeviceEmulation implements I2CDevice {
     ...
     */
    @Override
    public void write(final byte data) throws HardwareEmulationException {
    	 if (! bus.write(getAddress(), new byte[]{data}))
    		 throw new HardwareEmulationException("Error writing to " + makeDescription() + ". Not implemented!");
    }
     ...
     */
    @Override
    public void write(final byte[] data, final int offset, final int size) throws HardwareEmulationException {
     ...
     */
    @Override
    public void write(byte[] buffer) throws HardwareEmulationException {
     ...
     */
    @Override
    public void write(final int address, final byte data) throws HardwareEmulationException {
    	if (! bus.write(getAddress(),address, new byte[]{data}))
            throw new HardwareEmulationException("Error writing to " + makeDescription(address) + ". Not implemented!");
    }
     ...
     */
    @Override
    public void write(final int address, final byte[] data, final int offset, final int size) throws HardwareEmulationException {
     ...
     */
    @Override
    public int read() throws HardwareEmulationException {
     ...
     */
    @Override
    public int read(final byte[] data, final int offset, final int size) throws HardwareEmulationException {
     ...
     */
    @Override
    public int read(final int address) throws HardwareEmulationException {
     ...
     */
    @Override
    public int read(final int address, final byte[] data, final int offset, final int size) throws HardwareEmulationException {
     ...
     */
    @Override
    public int read(final byte[] writeData, final int writeOffset, final int writeSize, final byte[] readData, final int readOffset, final int readSize) throws HardwareEmulationException {
    		write(getAddress(),writeData, writeOffset, writeSize);
    		read(getAddress(),readData, readOffset, readSize);
            throw new HardwareEmulationException("Error reading from " + makeDescription() + ". Not implemented!");
    }
