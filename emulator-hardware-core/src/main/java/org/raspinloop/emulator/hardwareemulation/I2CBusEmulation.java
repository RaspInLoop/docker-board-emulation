...
public class I2CBusEmulation implements I2CBus {
	...
	Map<Integer, I2CCompHardwareEmulation> emulatedDevicesOnBus = new HashMap<>();
    ...
    public I2CDevice getDevice(int address) throws IOException {
    	return devices.computeIfAbsent(address, key -> new I2CDeviceEmulation(this, key));
    }

	public void register(I2CCompHardwareEmulation hw) {
	...
	public boolean write(int devAddress, byte[] bs) {
		I2CCompHardwareEmulation dev = emulatedDevicesOnBus.get(devAddress);
		return dev.write(bs);	
	}
